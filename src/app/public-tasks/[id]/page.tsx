...
import { PublicTask, TaskCompletionType, TaskLocationType, PayoutMethod, GradingMethod, User, PublicTaskApplication, ApplicationStatus } from '../../../types';
...
function formatLocationType(type: TaskLocationType) {
  switch (type) {
    case TaskLocationType.REMOTE: return 'Remote';
    case TaskLocationType.ONSITE: return 'On-site';
    case TaskLocationType.HYBRID: return 'Hybrid';
    default: return type;
  }
}
