...
const CreatePublicTaskModal: React.FC<CreatePublicTaskModalProps> = ({
  ...
  const [formData, setFormData] = useState<CreatePublicTaskData>({
    ...
    locationType: TasklAppocationType.REMOTE,
    locationAddress: '',
    locationCity: '',
    locationCountry: '',
    language: 'English',
      ...
      <div className={styles.modal}>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.fieldRow}>
              ...
              <div className={styles.field}>
                ...
                <select
                  ...
                  onChange={(e) => handleInputChange('locationType', e.target.value as TasklAppocationType)}
                >
            ...
            {formData.locationType !== TasklAppocationType.REMOTE && (
              <div className={styles.fieldRow}>
                <div className={styles.field}>
                  <label>City</label>
                  <input
