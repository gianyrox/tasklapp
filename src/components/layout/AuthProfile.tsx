...
interface MiniAuthProfileProps {
...
// Mini profile component for homepage and mobile use
const MiniAuthProfile: React.FC<MiniAuthProfileProps> = ({ 
  onClick, 
  showMenuIcon = false, 
  ...
  if (!user) {
    // Non-logged-in state - grey profile icon
    return (
      <div className={`${styles.mobileMenuContainer} ${className}`}>
  ...
  return (
    <div className={`${styles.mobileMenuContainer} ${className}`}>
      <div className={styles.mobileMenuRow} onClick={onClick}>
        {showMenuIcon && (
          <div className={styles.menuIcon}>
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              {showMobileMenu ? (
...
export const AuthProfile: React.FC<AuthProfileProps> = ({ 
  ...
  if (!user) {
    // Non-logged-in state - use MiniAuthProfile for consistency
    return (
      <MiniAuthProfile 
        className={className}
        showMenuIcon={true}
  ...
  return (
    <>
      ...
      {/* Mobile Menu - Use MiniAuthProfile component */}
      <MiniAuthProfile 
